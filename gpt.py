...
from src.gpt.src.result_handler import handle_result, TAKEN_FROM_PARAMS_STR, RATED_STR
...
for offer_record in offers_data:
    if offer_record not in list_of_id_in_gpt_database:
        if offer_record["description"] == ' ':
            ...
            # Assess balcony
            balcony_description = create_lemmatized_parameter_description('flats',
                                                                          offer_record["description"],
                                                                          'balcony')
            balcony_summary, balcony_rating = assess_offer_parameter('balcony',
                                                     offer_record,
                                                     balcony_description)
