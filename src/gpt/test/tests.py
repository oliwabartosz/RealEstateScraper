...
from src.gpt.test.test_gpt import test_gpt_old


def start_balcony_gpt_test(start=True):
    if start:
        print('Test: balcony:')
        test_gpt_old([balcony_summary_chain, balcony_rating_chain],
...
def start_law_status_test(start=True):
    if start:
        ...
        test_gpt_old([law_status_summary_chain, law_status_rating_chain],
...
def start_monitoring_test(start=True):
    if start:
        ...
        test_gpt_old([monitoring_summary_chain, monitoring_rating_chain],
...
def start_basement_test(start=True):
    if start:
        print('Test: basement:')
        test_gpt_old([basement_summary_chain, basement_rating_chain],
...
def start_elevator_test(start=True):
    if start:
        print('Test: elevator:')
        test_gpt_old([elevator_summary_chain, elevator_rating_chain],
...
def start_garage_test(start=True):
    if start:
        print('Test: garage:')
        test_gpt_old([garage_summary_chain, garage_rating_chain],
...
def start_garden_test(start=True):
    if start:
        print('Test: garden:')
        test_gpt_old([garden_summary_chain, garden_rating_chain],
...
def start_kitchen_test(start=True):
    if start:
        print('Test: kitchen:')
        test_gpt_old([kitchen_summary_chain, kitchen_rating_chain],
...
def start_modernization_test(start=True):
    if start:
        ...
        test_gpt_old([modernization_summary_chain, modernization_rating_chain],
...
def start_outbuilding_test(start=True):
    if start:
        ...
        test_gpt_old([outbuilding_summary_chain, outbuilding_rating_chain],
