...
FILE_PATH_TEMPLATES = './src/scrapper/prompts/chunks_templates.json'
FILE_PATH_FLATS_DICTIONARY = './src/scrapper/prompts/flats_dictionary.json'
FILE_PATH_HOUSES_DICTIONARY = './src/scrapper/prompts/houses_dictionary.json'
FILE_PATH_PLOTS_DICTIONARY = './src/scrapper/prompts/plots_dictionary.json'
# GPT
